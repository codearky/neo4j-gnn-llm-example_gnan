...
def train(
    ...
    # Compute and display node importance for 3 random test samples
    if num_gnn_layers > 0:
        print("\nNode importance on 3 random test examples:")
        sample_indices = torch.randperm(len(test_dataset))[:3].tolist()
